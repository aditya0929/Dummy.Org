    ...
    <section className="about section" id="about">
      <div className="about-container container">
          <div className="about-content">
            ...
            <p className="about-desc about-desc-mb">Joining our organsization is a great way to enhance your skills, connect with peers who share your interests, and make a positive impact in the community. We look forward to welcoming you to our club and helping you achieve your educational goals!</p>
